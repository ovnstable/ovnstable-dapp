...
export default {
    ...
    methods: {
        ...
        async buyAction() {
            ...
            this.showWaitingModal('Swapping ' + this.sumResult + ' USD+ for ' + this.sumResult + ' USD+/WMatic');
        ...
        async checkAllowance(sum) {
            ...
            let allowanceValue = await contracts.usdPlus.methods.allowance(from, contracts.exchangerUsdPlusWmatic.options.address).call();
            ...
            if (allowanceValue < sum) {
                try {
                    ...
                    let tx = await contracts.usdPlus.methods.approve(contracts.exchangerUsdPlusWmatic.options.address, sum).send(approveParams);
                        ...
                        if (error && error.message) {
                            ...
                            let errorMsg = {
                                ...
                                data: {
                                    ...
                                    method: contracts.exchangerUsdPlusWmatic.methods.buy(sum, referral).encodeABI(),
                                    message: msg,
                                    block: blockNum
                                }
                            };
