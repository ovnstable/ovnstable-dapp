<template>
    <div v-if="showEtsMoonstoneModal">
        <v-dialog
                v-model="showEtsMoonstoneModal"
                width="600"
                persistent>
...
import Invest from "@/components/market/modal/etsMoonstone/invest/action/Invest";
import Withdraw from "@/components/market/modal/etsMoonstone/invest/action/Withdraw";
...
export default {
    ...
    computed: {
        ...mapGetters('investModal', ['showEtsMoonstoneModal']),
    ...
    methods: {
        ...mapActions('investModal', ['closeEtsMoonstoneModal']),
