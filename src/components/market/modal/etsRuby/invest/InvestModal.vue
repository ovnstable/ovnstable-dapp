<template>
    <div v-if="showEtsRubyModal">
        <v-dialog
                v-model="showEtsRubyModal"
                width="600"
                persistent>
...
import Invest from "@/components/market/modal/etsRuby/invest/action/Invest";
import Withdraw from "@/components/market/modal/etsRuby/invest/action/Withdraw";
...
export default {
    ...
    computed: {
        ...mapGetters('investModal', ['showEtsRubyModal']),
    ...
    methods: {
        ...mapActions('investModal', ['closeEtsRubyModal']),
