...
const actions = {
    ...
    async refreshStrategyData({commit, dispatch, getters, rootState}, refreshParams) {
        console.log("refreshStrategyData: " + refreshParams.contractAddress + refreshParams.strategyName)
        let fetchOptions = {
            headers: {
        ...
        await fetch(process.env.VUE_APP_API + '/hedge-strategies/' + refreshParams.contractAddress + '/avg-apy-info/week', fetchOptions)
            .then(value => value.json())
            .then(value => {
        ...
        await fetch(process.env.VUE_APP_API + '/hedge-strategies/' + refreshParams.contractAddress, fetchOptions)
            .then(value => value.json())
            .then(value => {
                strategyData = value;
    ...
    async refreshClientData({commit, dispatch, getters, rootState}, refreshParams) {
        ...
        await fetch(process.env.VUE_APP_API + '/hedge-strategies/' + refreshParams.contractAddress + '/account/' + account, fetchOptions)
            .then(value => value.json())
            .then(value => {
