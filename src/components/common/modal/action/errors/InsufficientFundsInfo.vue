<template>
    <div class="main-container" :class="$wu.isMobile() ? 'px-2 pt-2' : 'px-5 pt-5'">
        ...
        <div class="loading-img">
            <v-img :src="require('@/assets/icon/insufficient-funds.svg')"/>
        </div>
        ...
        <div class="info-container" :class="$wu.isMobile() ? 'pa-2 pt-4' : 'pa-5'">
            <div class="info-container-text">
                There are not enough tokens in your wallet for the<br/>
                transaction. Top up your balance and try again.
            </div>
        </div>
    </div>
</template>
