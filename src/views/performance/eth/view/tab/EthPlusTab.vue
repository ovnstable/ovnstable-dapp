  ...
  <div class="page-container">
    ...
    >
      <v-col class="info-card-body-bottom">
        <v-row align="start" justify="start" class="ma-0">
          <label class="section-title-label"> ETH+ collateral assets </label>
        </v-row>
    ...
    >
      <v-col class="info-card-body-bottom">
        <v-row align="center" justify="start" class="ma-0">
          <label class="section-title-label"> ETH+ portfolio </label>
        </v-row>
    ...
    >
      ...
      >
        <v-img
          class="currency"
          :src="require('@/assets/currencies/ETH+.svg')"
        />
      </div>
      <div
      ...
      >
        ...
        <label class="section-text">
          ETH+ is the equivalent of USD+, pegged to WETH 1:1, instantly mintable
          and redeemable in WETH. 100% collateralized with delta-neutral and
          other strategies based on the best protocols.
        </label>
      </div>
    </div>
