                    ...
                    <v-row class="d-flex mt-4">
                        ...
                        <div class="tooltip">
                            <Tooltip icon-color="#FFFFFF"
                                     ...
                                     text="Net APY based on 30-day average, includes fees taken (fee-adjusted)"/>
                        </div>
                    </v-row>
                </v-row>
            </v-row>
                    ...
                    <v-col cols="12">
                      ...
                      <v-row class="ma-0 mt-3 insurance-card-info-row d-flex justify-space-between info-container">
                          ...
                          <div class="tooltip-info">
                            <Tooltip :size="$wu.isFull() ? 18 : ($wu.isTablet() ? 16 : 14)"
                                     :maxWidth="300"
                                     text="Insurance premiums APY consists of the retained portion of the USD+ yield."/>
                          </div>
                        </v-row>
                        ...
                        <v-row class="ma-0 mt-3 insurance-card-info-row d-flex justify-space-between info-container">
                          ...
                          <div class="tooltip-info">
                            <Tooltip :size="$wu.isFull() ? 18 : ($wu.isTablet() ? 16 : 14)"
                                     text="Reserve investment APY consists of the yield generated by investing <a>insurance reserves.</a>"
