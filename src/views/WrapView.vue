        ...
        <v-row align="center" justify="center">
            <v-col class="main-col">
                ...
                <v-row class="desc justify-start mt-5">
                    <p>wUSD+ is an index-adjusted wrapper for USD+. Some people may find this useful for cross-blockchain purposes. Unlike your USD+ balance, your wUSD+ balance will not increase over time. When wUSD+ is unwrapped, you receive USD+ based on the latest (ever-increasing) index - the total yield is the same.</p>
                </v-row>
