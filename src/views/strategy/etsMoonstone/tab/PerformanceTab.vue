    ...
    <div>
        <v-row class="ma-0 info-card-container" :class="$wu.isMobile() ? 'mt-5' : 'mt-10'" justify="start" align="center">
            <v-col class="info-card-body-bottom">
                ...
                <ChartApy class="mx-n3" v-if="rateTab === 1" :data="apyDataEtsMoonstone" :usdPlusData="apyDataUsdPlusPolygon" ets-name="ETS MOONSTONE"/>
                <ChartTvl class="mx-n3" v-if="rateTab === 3" :data="tvlDataEtsMoonstone" ets-name="ETS MOONSTONE"/>
            </v-col>
        </v-row>
        ...
        <v-row align="center" justify="start" class="ma-0" :class="$wu.isMobile() ? 'mt-5' : 'mt-10'">
            ...
            <div v-if="!$wu.isMobile()" class="info-card-container-debank" @click="openLink('https://debank.com/profile/0x67B274096051Fb9835e4475f5371220Eea9F5070')">
        ...
        <v-row v-if="$wu.isMobile()" align="center" justify="start" class="ma-0 mt-5">
            <div class="info-card-container-debank" style="width: 100% !important;" @click="openLink('https://debank.com/profile/0x67B274096051Fb9835e4475f5371220Eea9F5070')">
        ...
        <v-row v-if="etsMoonstoneStrategyData && etsMoonstoneStrategyData.ownedAsset" align="start" justify="start" class="ma-0" :class="$wu.isMobile() ? 'mt-4' : 'mt-4'">
                ...
                <v-row class="info-card-container" justify="start" align="center">
                    <v-col class="info-card-body">
                        ...
                        <v-row class="info-row mt-8" justify="start" align="center">
                            ...
                            <v-spacer></v-spacer>
                            <label class="card-info-value">{{ etsMoonstoneStrategyData ? etsMoonstoneStrategyData.ownedAsset.token : '—' }}</label>
                        ...
                        <v-row class="info-row mt-8" justify="start" align="center">
                            ...
                            <label class="card-info-value">
                                {{ etsMoonstoneStrategyData ? $utils.formatMoneyComma(etsMoonstoneStrategyData.ownedAsset.amount, 0) : '—' }}
                                {{ etsMoonstoneStrategyData ? etsMoonstoneStrategyData.ownedAsset.token : '—' }}
                            </label>
                        </v-row>
                        <v-row class="info-row mt-8" justify="start" align="center">
                            ...
                            <v-spacer></v-spacer>
                            <label class="card-info-value">
                                {{ etsMoonstoneStrategyData ? $utils.formatMoneyComma(etsMoonstoneStrategyData.ownedAsset.amountUsdc, 0) : '—' }}
                                USD
                            </label>
                        </v-row>
                    </v-col>
                ...
                <v-row class="info-card-container" justify="start" align="center">
                    <v-col class="info-card-body">
                        ...
                        <v-row class="info-row mt-8" justify="start" align="center">
                            <label class="card-info mt-2">Token</label>
                            <v-spacer></v-spacer>
                            <label class="card-info-value">{{ etsMoonstoneStrategyData ? etsMoonstoneStrategyData.depositAsset.token : '—' }}</label>
                            <div class="info-card-icon ml-2">
                                <v-img :src="require('@/assets/currencies/usdc.png')"/>
                            </div>
                        </v-row>
                        <v-row class="info-row mt-8" justify="start" align="center">
                            ...
                            <v-spacer></v-spacer>
                            <label class="card-info-value">
                                {{ etsMoonstoneStrategyData ? $utils.formatMoneyComma(etsMoonstoneStrategyData.depositAsset.amount, 0) : '—' }}
                                {{ etsMoonstoneStrategyData ? etsMoonstoneStrategyData.depositAsset.token : '—' }}
                            </label>
                        </v-row>
                        <v-row class="info-row mt-8" justify="start" align="center">
                            <label class="card-info mt-2">Value</label>
                            <v-spacer></v-spacer>
                            <label class="card-info-value">
                                {{ etsMoonstoneStrategyData ? $utils.formatMoneyComma(etsMoonstoneStrategyData.depositAsset.amountUsdc, 0) : '—' }}
                                USD
                            </label>
                        </v-row>
                    </v-col>
                ...
                <v-row class="info-card-container" justify="start" align="center">
                    <v-col class="info-card-body">
                        ...
                        <v-row class="info-row mt-8" justify="start" align="center">
                            <label class="card-info mt-2">Token</label>
                            <v-spacer></v-spacer>
                            <label class="card-info-value">{{ etsMoonstoneStrategyData ? etsMoonstoneStrategyData.borrowedAsset.token : '—' }}</label>
                            <div class="info-card-icon ml-2">
                        ...
                        <v-row class="info-row mt-8" justify="start" align="center">
                            ...
                            <v-spacer></v-spacer>
                            <label class="card-info-value">
                                {{ etsMoonstoneStrategyData ? $utils.formatMoneyComma(etsMoonstoneStrategyData.borrowedAsset.amount, 0) : '—' }}
                                {{ etsMoonstoneStrategyData ? etsMoonstoneStrategyData.borrowedAsset.token : '—' }}
                            </label>
                        </v-row>
                        <v-row class="info-row mt-8" justify="start" align="center">
                            <label class="card-info mt-2">Value</label>
                            <v-spacer></v-spacer>
                            <label class="card-info-value">
                                {{ etsMoonstoneStrategyData ? $utils.formatMoneyComma(etsMoonstoneStrategyData.borrowedAsset.amountUsdc, 0) : '—' }}
                                USD
                            </label>
                        </v-row>
                    </v-col>
                ...
                <v-row class="info-card-container-bottom" justify="start" align="center">
                    <v-col class="info-card-body-bottom">
                        <v-row align="center">
                            ...
                            <label class="card-info-value ml-2">{{ (etsMoonstoneStrategyData && etsMoonstoneStrategyData.currentHealthFactor) ? ($utils.formatMoneyComma(etsMoonstoneStrategyData.currentHealthFactor, 2)) : '—' }}</label>
                            ...
                            <label class="card-info-value ml-2">{{ (etsMoonstoneStrategyData && etsMoonstoneStrategyData.targetHealthFactor) ? ($utils.formatMoneyComma(etsMoonstoneStrategyData.targetHealthFactor, 2)) : '—' }}</label>
                            <v-spacer></v-spacer>
                        </v-row>
                    </v-col>
                </v-row>
        ...
        <v-row class="ma-0 info-card-container" :class="$wu.isMobile() ? 'mt-5' : 'mt-6'" justify="start" align="center">
            <v-col class="info-card-body-bottom">
                <v-row align="center" justify="start" class="ma-0">
                    <label class="section-title-label">ETS MOONSTONE payouts</label>
                </v-row>
                ...
                <v-row align="center" justify="center">
                    <v-col :cols="!$wu.isFull() ? 12 : 8">
                        <Table
                                v-if="!$wu.isMobile()"
                                profit-label="USDC per ETS MOONSTONE"
                                :payout-data="etsMoonstoneStrategyData ? [...etsMoonstoneStrategyData.payoutItems].reverse() : []"/>
...
export default {
    ...
    computed: {
        ...mapGetters('marketData', ['etsMoonstoneStrategyData', 'apyDataEtsMoonstone', 'tvlDataEtsMoonstone', 'apyDataUsdPlusPolygon']),
        ...
        lastPayoutDate: function () {
            return this.etsMoonstoneStrategyData ? this.etsMoonstoneStrategyData.payoutItems[this.etsMoonstoneStrategyData.payoutItems.length - 1].payableDate : null;
        },
    },
