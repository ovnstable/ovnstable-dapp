                    ...
                    <v-row align="center" justify="start" class="info-container ma-0">
                        <v-col>
                            ...
                            <v-row justify="center" align="center" class="mt-2">
                                <label class="info-value mr-n1">{{ (etsRubyStrategyData && etsRubyStrategyData.apy) ? ($utils.formatMoneyComma(etsRubyStrategyData.apy, 0)) + '%' : '—' }}</label>
                        ...
                        <v-col class="bordered-col" cols="5">
                            ...
                            <v-row justify="center" align="center" class="mt-2">
                                <label class="info-value" :class="(totalSupply.etsRuby >= maxEtsRubySupply) ? 'label-error' : ''">
                        ...
                        <v-col>
                            ...
                            <v-row justify="center" align="center" class="mt-2">
                                <label class="info-value">{{ (etsRubyStrategyData && etsRubyStrategyData.holders) ? $utils.formatMoneyComma(etsRubyStrategyData.holders, 0) : '—' }}</label>
                            </v-row>
                        </v-col>
                    </v-row>
                </v-col>
                    ...
                    <v-row align="center" justify="start" class="info-container-capacity ma-0">
                        <v-col class="card-banner-body">
                            <v-row class="ma-0" justify="start" align="center">
                                ...
                                <v-spacer></v-spacer>
                                <label class="capacity-status-value" :class="totalSupply.etsRuby >= maxEtsRubySupply ? 'label-error' : ''">
                                    {{ totalSupply.etsRuby >= maxEtsRubySupply ? 'FULL' : 'AVAILABLE' }}
                                </label>
                            </v-row>
                            <v-row class="ma-0 mt-2" justify="start" align="center">
                                <v-progress-linear
                                        ...
                                        :value="(totalSupply.etsRuby / maxEtsRubySupply) * 100"
                                        :color="totalSupply.etsRuby >= maxEtsRubySupply ? '#CF3F92' : '#1C95E7'"
                                ></v-progress-linear>
                            </v-row>
                            <v-row class="ma-0 mt-2" justify="start" align="center">
                                <label class="capacity-status-sub-text">${{ $utils.formatMoneyComma(totalSupply.etsRuby, 2) }}</label>
                                <v-spacer></v-spacer>
                                <label class="capacity-status-sub-text">${{ $utils.formatMoneyComma(maxEtsRubySupply, 2) }}</label>
                            </v-row>
                            <v-row class="ma-0" justify="start" align="center">
