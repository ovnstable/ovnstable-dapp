<template>
  <v-menu transition="slide-y-reverse-transition" offset-y>
        ...
        <div v-if="!openedList">
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M0.853968 0.793159C0.34928 1.2642 0.34928 2.02791 0.853968 2.49896L8.72813 9.84817C8.7295 9.84946 8.73087 9.85074 8.73224 9.85203C9.11076 10.2053 9.66566 10.2936 10.1324 10.117C10.2879 10.0581 10.4337 9.96978 10.5599 9.85203C10.5599 9.85202 10.5599 9.85202 10.5599 9.85202L18.4382 2.49896C18.9428 2.02792 18.9428 1.26421 18.4382 0.793169C17.9335 0.322126 17.1152 0.322126 16.6105 0.793169L9.64607 7.29332L2.68161 0.793159C2.17692 0.322117 1.35866 0.322117 0.853968 0.793159Z"
              fill="#009AFF"
              fill-opacity="0.92"
            />
          </svg>
    ...
    <v-list class="token-select-list">
          ...
          <div class="balance-container">
            ...
            >
              {{
                dataHidden
                  ? "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                  : $utils.formatMoney(account ? balance.ethPlus : 0, 4)
              }}
            </label>
          ...
          <div class="balance-container">
            ...
            >
              {{
                dataHidden
                  ? "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                  : $utils.formatMoney(account ? balance.usdPlus : 0, 4)
              }}
            </label>
            <label class="balance-label token-label">
              &nbsp;USD+
      ...
      <v-list-item
        style="cursor: pointer"
        @click="selectToken('usdcPlus', 'USDC+')"
        v-if="checkNetworkIdToken('USDC+')"
      >
        <v-list-item-title class="token-select-list-item">
          <div class="balance-container">
            <label
            ...
            >
              {{
                dataHidden
                  ? "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                  : $utils.formatMoney(account ? balance.usdcPlus : 0, 4)
              }}
            </label>
            <label class="balance-label token-label">
              &nbsp;USDC+
          ...
          <div class="balance-container">
            ...
            >
              {{
                dataHidden
                  ? "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                  : $utils.formatMoney(account ? balance.usdtPlus : 0, 4)
              }}
            </label>
            <label class="balance-label token-label">
              &nbsp;USDT+
          ...
          <div class="balance-container">
            ...
            >
              {{
                dataHidden
                  ? "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                  : $utils.formatMoney(account ? balance.ovn : 0, 4)
              }}
            </label>
            <label class="balance-label token-label">
              &nbsp;OVN
