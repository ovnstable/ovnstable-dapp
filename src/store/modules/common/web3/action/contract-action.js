...
const actions = {
    async initContracts({commit, dispatch, getters, rootState}) {
        ...
        [
            ...
            // Exchange
            load(ABI_Exchange,web3,chainContractsMap[network]["usdPlus"]?.exchange ?? null),
            load(ABI_Exchange,web3,chainContractsMap[network]["daiPlus"]?.exchange ?? null),
            load(ABI_Exchange,web3,chainContractsMap[network]["usdtPlus"]?.exchange ?? null),
            load(ABI_Exchange,web3,chainContractsMap[network]["ethPlus"]?.exchange ?? null),

            // ovn
            load(ABI_Ovn,web3,chainContractsMap[network]?.ovn ?? null),
            load(ABI_OvnGovernor,web3,chainContractsMap[network]?.ovnGovernor ?? null),

            // PM
            load(ABI_PortfolioManager,web3,chainContractsMap[network]["usdPlus"]?.portfolioManager ?? null),
            load(ABI_PortfolioManager,web3,chainContractsMap[network]["daiPlus"]?.portfolioManager ?? null),
            load(ABI_PortfolioManager,web3,chainContractsMap[network]["usdtPlus"]?.portfolioManager ?? null),
            load(ABI_PortfolioManager,web3,chainContractsMap[network]["ethPlus"]?.portfolioManager ?? null),
            load(ABI_OvnTimelock,web3,chainContractsMap[network]?.ovnTimelockController ?? null),
  
            // plus
            load(ABI_PlusToken,web3,chainContractsMap[network]["usdPlus"]?.tokenPlus ?? null),
            load(ABI_PlusToken,web3,chainContractsMap[network]["daiPlus"]?.tokenPlus ?? null),
            load(ABI_PlusToken,web3,chainContractsMap[network]["usdtPlus"]?.tokenPlus ?? null),
            load(ABI_PlusToken,web3,chainContractsMap[network]["ethPlus"]?.tokenPlus ?? null),

            // m2m
            load(ABI_Mark2market,web3,chainContractsMap[network]["usdPlus"]?.mark2market ?? null),
            load(ABI_Mark2market,web3,chainContractsMap[network]["daiPlus"]?.mark2market ?? null),
            load(ABI_Mark2market,web3,chainContractsMap[network]["usdtPlus"]?.mark2market ?? null),
            load(ABI_Mark2market,web3,chainContractsMap[network]["ethPlus"]?.mark2market ?? null),
