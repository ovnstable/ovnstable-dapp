    ...
    <v-row align="center" justify="start" class="banner-container ma-0">
        <v-col class="main-col">
            <v-row align="center" justify="start" class="ma-0" :class="$wu.isMobile() ? 'mt-1 mb-3' : 'mb-12'">
                ...
                <label class="banner-title ml-4">ETS: WMatic / USDC</label>
                <v-spacer></v-spacer>
                    ...
                    <v-row align="center" justify="start" class="info-container ma-0">
                        <v-col>
                            ...
                            <v-row justify="center" align="center" class="mt-2">
                                <label class="info-value mr-n1">{{ (wmaticUsdcStrategyData && wmaticUsdcStrategyData.apy) ? ($utils.formatMoneyComma(wmaticUsdcStrategyData.apy, 0)) + '%' : '—' }}</label>
                        ...
                        <v-col class="bordered-col" cols="5">
                            ...
                            <v-row justify="center" align="center" class="mt-2">
                                <label class="info-value" :class="(totalSupply.wmaticUsdc >= maxWmaticUsdcSupply) ? 'label-error' : ''">
                        ...
                        <v-col>
                            ...
                            <v-row justify="center" align="center" class="mt-2">
                                <label class="info-value">{{ (wmaticUsdcStrategyData && wmaticUsdcStrategyData.holders) ? $utils.formatMoneyComma(wmaticUsdcStrategyData.holders, 0) : '—' }}</label>
                            </v-row>
                        </v-col>
                    </v-row>
                </v-col>
                    ...
                    <v-row align="center" justify="start" class="info-container-capacity ma-0">
                        <v-col class="card-banner-body">
                            <v-row class="ma-0" justify="start" align="center">
                                ...
                                <v-spacer></v-spacer>
                                <label class="capacity-status-value" :class="totalSupply.wmaticUsdc >= maxWmaticUsdcSupply ? 'label-error' : ''">
                                    {{ totalSupply.wmaticUsdc >= maxWmaticUsdcSupply ? 'FULL' : 'AVAILABLE' }}
                                </label>
                            </v-row>
                            <v-row class="ma-0 mt-2" justify="start" align="center">
                                <v-progress-linear
                                        ...
                                        :value="(totalSupply.wmaticUsdc / maxWmaticUsdcSupply) * 100"
                                        :color="totalSupply.wmaticUsdc >= maxWmaticUsdcSupply ? '#CF3F92' : '#1C95E7'"
                                ></v-progress-linear>
                            </v-row>
                            <v-row class="ma-0 mt-2" justify="start" align="center">
                                <label class="capacity-status-sub-text">${{ $utils.formatMoneyComma(totalSupply.wmaticUsdc, 2) }}</label>
                                <v-spacer></v-spacer>
                                <label class="capacity-status-sub-text">${{ $utils.formatMoneyComma(maxWmaticUsdcSupply, 2) }}</label>
                            </v-row>
                            <v-row class="ma-0" justify="start" align="center">
