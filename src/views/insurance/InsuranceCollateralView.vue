    ...
    <div class="mt-1">
      <v-row align="start" justify="start" class="main-container ma-0">
        ...
        >
              ...
              <div class="my-4">
                ...
                <template v-else>
                  <v-row align="center" justify="center" class="ma-0">
                    <v-btn
                      class="header-btn btn-investor-invest"
                      @click="setWalletNetwork(activeTabName)"
                    >
          ...
          <InsuranceCollateralTab :chain-name="activeTabName" />
        </v-col>
...
import InsuranceCollateralTab from "@/views/insurance/tab/CollateralTab.vue";

export default {
  name: "InsuranceCollateralView",

  components: {
    InsuranceCollateralTab,
    InsuranceRiskModal,
    Tooltip
  },
  ...
  methods: {
    ...
    setTab(tabName) {
      ...
      this.$router.push(
        `/insurance/collateral/${tabName === 10 ? "optimism" : "arbitrum"}`
      );
    },
    ...
    async refreshClientData() {
      ...
      insuranceApiService
        ...
        .then(async (value) => {
          ...
          if ([10, 42161].includes(this.networkId)) {
