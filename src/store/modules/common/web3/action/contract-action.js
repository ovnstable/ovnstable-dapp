    ...
    outputs: [
      {
        ...
        internalType: "struct IMark2Market.StrategyAsset[]",
        name: "",
        type: "tuple[]"
      }
    ],
  ...
  async initContracts({ commit, dispatch, getters, rootState }) {
    ...
    [
      ...
      load(
        ABI_Exchange,
        web3,
        chainContractsMap[network]["usdPlus"]?.exchange ?? null
      ),
      load(
        ABI_Exchange,
        web3,
        chainContractsMap[network]["usdcPlus"]?.exchange ?? null
      ),
      load(
        ABI_Exchange,
        web3,
        chainContractsMap[network]["daiPlus"]?.exchange ?? null
      ),
      load(
        ABI_Exchange,
        web3,
        chainContractsMap[network]["usdtPlus"]?.exchange ?? null
      ),
      load(
        ABI_Exchange,
        web3,
        chainContractsMap[network]["ethPlus"]?.exchange ?? null
      ),

      // ovn
      load(ABI_Ovn, web3, chainContractsMap[network]?.ovn ?? null),
      load(
        ABI_OvnGovernor,
        web3,
        chainContractsMap[network]?.ovnGovernor ?? null
      ),
      ...
      load(
        ...
        web3,
        chainContractsMap[network]["usdPlus"]?.portfolioManager ?? null
      ),
      load(
        ABI_PortfolioManager,
        web3,
        chainContractsMap[network]["usdcPlus"]?.portfolioManager ?? null
      ),
      load(
        ABI_PortfolioManager,
        web3,
        chainContractsMap[network]["daiPlus"]?.portfolioManager ?? null
      ),
      load(
        ABI_PortfolioManager,
        web3,
        chainContractsMap[network]["usdtPlus"]?.portfolioManager ?? null
      ),
      load(
        ABI_PortfolioManager,
        web3,
        chainContractsMap[network]["ethPlus"]?.portfolioManager ?? null
      ),
      load(
        ABI_OvnTimelock,
        web3,
        chainContractsMap[network]?.ovnTimelockController ?? null
      ),
      ...
      load(
        ABI_PlusToken,
        web3,
        chainContractsMap[network]["usdPlus"]?.tokenPlus ?? null
      ),
      load(
        ABI_PlusToken,
        web3,
        chainContractsMap[network]["usdcPlus"]?.tokenPlus ?? null
      ),
      load(
        ABI_PlusToken,
        web3,
        chainContractsMap[network]["daiPlus"]?.tokenPlus ?? null
      ),
      load(
        ABI_PlusToken,
        web3,
        chainContractsMap[network]["usdtPlus"]?.tokenPlus ?? null
      ),
      load(
        ABI_PlusToken,
        web3,
        chainContractsMap[network]["ethPlus"]?.tokenPlus ?? null
      ),
      ...
      load(
        ABI_Mark2market,
        web3,
        chainContractsMap[network]["usdPlus"]?.mark2market ?? null
      ),
      load(
        ABI_Mark2market,
        web3,
        chainContractsMap[network]["usdcPlus"]?.mark2market ?? null
      ),
      load(
        ABI_Mark2market,
        web3,
        chainContractsMap[network]["daiPlus"]?.mark2market ?? null
      ),
      load(
        ABI_Mark2market,
        web3,
        chainContractsMap[network]["usdtPlus"]?.mark2market ?? null
      ),
      load(
        ABI_Mark2market,
        web3,
        chainContractsMap[network]["ethPlus"]?.mark2market ?? null
      ),
      ...
      load(
        ABI_WusdPlus,
        web3,
        chainContractsMap[network]["usdPlus"]?.wUsdPlus ?? null
      ),
      load(
        ABI_WusdPlus,
        web3,
        chainContractsMap[network]["wEthPlus"]?.tokenPlus ?? null
      ),
      ...
      load(ERC20_ABI, web3, chainContractsMap[network]?.usdcNative ?? null),
    ...
    for (let i = 0; i < insurances.length; i++) {
      if (network === insurances[i].network) {
        contracts.insurance = {};
        contracts.insurance[insurances[i].network + "_exchanger"] = load(
          EXCHANGER_INSURANCE_ABI,
          web3,
          chainContractsMap[network]?.exchange_insurance ?? null
        );
        contracts.insurance[insurances[i].network + "_token"] = load(
          INSURANCE_TOKEN_ABI,
          web3,
          chainContractsMap[network]?.token_insurance ?? null
        );
      }
    }
...
function load(abi, web3, address) {
  if (address == null) {
    return null;
  }
