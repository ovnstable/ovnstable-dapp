    ...
    <v-row class="card-container ma-0" @click="openStrategyCard">
        <v-col cols="12" align-self="start">
            ...
            <v-row class="card-row mt-12" justify="start" align="center">
                ...
                <label class="card-title ml-3">ETS RUBY</label>
                <v-spacer></v-spacer>
                <div class="currency-icon">
            ...
            <v-row class="card-row mt-12" :class="$wu.isMobile ? '' : 'mb-15'" justify="start" align="center">
                <label class="card-info">Generate yield on wETH-USDC pool by hedging your risks and simplify process</label>
            </v-row>
            ...
            <v-row class="card-row card-banner-container mt-7" justify="start" align="center">
                <v-col class="card-banner-body">
                    <v-row align="center">
                        ...
                        <label :class="$wu.isMobile() ? 'card-info-banner' : 'card-info'" class="ml-2">Hedging against ETH price volatility</label>
                    </v-row>
                    <v-row align="center">
