      ...
      <v-card class="container_body airdrop-body">
        <v-toolbar class="container_header" flat>
          <label class="title-modal mt-4">
            {{ isMintView ? "Mint Usdc+" : "Redeem Usdc+" }}
          </label>
          <v-spacer></v-spacer>
...
import Mint from "@/components/swap/usdc/action/Mint";
import Redeem from "@/components/swap/usdc/action/Redeem";
...
export default {
  ...
  computed: {
    ...mapGetters("swapUsdcModal", ["show"]),
    ...mapGetters("swapUsdcModal", ["isMintView"]),
  ...
  methods: {
    ...mapActions("swapUsdcModal", ["showUsdcSwapModal", "closeUsdcSwapModal"]),
