        ...
        async swap() {
            ...
            this.swapRequest(requestData)
                .then(async data => {
                    ...
                    this.assembleRequest(assembleData).then(async assembleData => {
                        console.log("Assemble data: ", assembleData)

                        if (assembleData.simulation && !assembleData.simulation.isSuccess) {
                            this.closeWaitingModal();
                            let errMsg = assembleData.simulation.simulationError && assembleData.simulation.simulationError.errorMessage ? assembleData.simulation.simulationError.errorMessage : 'Transaction simulation is failed';
                        ...
                        await this.initWalletTransaction(assembleData, this.selectedInputTokens, this.selectedOutputTokens);
