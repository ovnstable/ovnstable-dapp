<template>
  <v-row class="card-container">
    <v-col cols="12" align-self="start">
      <v-row
        class="d-flex flex-row align-center header-row pl-4"
        justify="center"
        :style="{
          '--card-background':
            'radial-gradient(108.67% 595.92% at 100% -3.25%, #001845 0%, #001845 27.05%, #0C255B 52.07%, ' +
            getParams(cardData.chain).networkColor +
            ' 100%)'
        }"
      >
            ...
            <v-row class="ma-0 mr-n2">
              <div class="box">
                ...
                <div class="icon">
                  <v-img
                    :src="
                      require('@/assets/network/' + cardData.chainName + '.svg')
                    "
                    class="mt-1"
                    alt="chain icon"
                  />
            ...
            <v-row class="ma-0 ml-n2">
              <div class="box">
                ...
                <div class="icon platform-logo">
                  <v-img
                    :src="
                      require('@/assets/cards/platform/' + dexLogo + '.svg')
                    "
                    class="mt-1"
                    alt="platform icon"
                  />
            ...
            <v-col class="mr-1">
              <v-row>
                ...
                <a
                  ...
                  :href="cardData.link"
                >
                  <v-btn class="button btn-outlined" outlined>
                    <label>STAKE</label>
                    <img
                      class="open-icon ml-1"
                      :src="require('@/assets/icon/open_in_new_blue.svg')"
                    />
                  </v-btn>
                </a>
              </v-row>
...
export default {
  ...
  methods: {
    ...
    openAllPools() {
      ...
      try {
        this.trackClick({
          action: "click_featured_pools",
          event_category: "Click button",
          event_label: "Click pools on featured page"
        });
      } catch (e) {
