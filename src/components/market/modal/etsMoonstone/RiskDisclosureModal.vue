            ...
            <v-card-text class="pt-8 content-container">
                <v-row class="modal-info-row" align="center">
                    <label class="modal-info-text">
                        ...
                        <br/><br/>
                        The strategy's smart contract is designed to automatically invest these equal values of WMATIC and USDC into QuickSwap's WMATIC/USDC Liquidity Pool, after which these LP Tokens are staked into the Gauge Pool on QuickSwap.
                        <br/><br/>
                        <b>Impermanent loss risk</b>
                        <br/>
                        Due to trading activities with the WMATIC/USDC pair on QuickSwap and/or WMATIC price change, the pool may become imbalanced, which can cause rebalance of a user’s LP position, resulting in increased or decreased number of WMATIC vs. borrowed in a position. When a user withdraws their investment, the strategy's smart contract may need to use a user's funds to buy additional WMATIC to repay the lent amount (plus interest), which can result in a net loss from the initial deposit.
                        <br/><br/>
                        <b>AMM contract hack risk</b>
                        <br/>
                        The strategy's smart contract automatically moves your deposit into the said Automated Market Maker (i.e., QuickSwap) and, in doing so, may incur an AMM’s smart contract risk.
                        <br/><br/>
