            ...
            <v-card class="container_body airdrop-body">
                <v-toolbar class="container_header" flat>
                    <label class="title-modal mt-4">
                        {{ isMintView ? 'Mint' : 'Withdraw' }} Insurance
                    </label>
                    <v-spacer></v-spacer>
...
import Mint from "@/components/insurance/modal/action/invest/action/Mint";
import Withdraw from "@/components/insurance/modal/action/invest/action/Withdraw";

export default {
    name: "InsuranceInvestModal",
