    ...
    <v-row class="card-container ma-0" @click="openStrategyCard">
        <v-col cols="12" align-self="start">
            ...
            <v-row class="card-row mt-12" justify="start" align="center">
                ...
                <label class="card-title ml-3">ETS: WMatic / USDC</label>
                <v-spacer></v-spacer>
                <div class="currency-icon">
            ...
            <v-row class="card-row mt-12" :class="$wu.isMobile ? '' : 'mb-15'" justify="start" align="center">
                <label class="card-info">Generate yield on wMatic-USDC pool by hedging your risks and simplify process</label>
            </v-row>
...
export default {
    ...
    methods: {
        openStrategyCard() {
            this.$router.push('/ets/wmatic-usdc');
